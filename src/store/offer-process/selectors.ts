...
export const getDataLoadingStatus = (state: Pick<State, NameSpace.Data>): boolean => state[NameSpace.Data].isOfferLoading;
...
export const makeSortedReviews = createSelector(
  [ getReviews ],(reviews) => [...reviews].sort((a, b) => new Date(a.date).getTime() - new Date(b.rating).getTime()) || []
);
